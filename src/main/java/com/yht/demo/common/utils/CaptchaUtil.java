...
//		cs.setWordFactory(arw);
		...
		cio.setStrokeMax(0.2f);
		cio.setStrokeMin(0.1f);
		filters.add(cio);*/
		
		
		/*BlurImageOp blurImageOp=new BlurImageOp();
		blurImageOp.setEdgeMode(AbstractImageOp.EDGE_ZERO);
		filters.add(blurImageOp);*/
		
		/*DiffuseImageOp diffuseImageOp=new DiffuseImageOp();
		diffuseImageOp.setEdgeMode(AbstractImageOp.EDGE_ZERO);
		diffuseImageOp.setAmount(0.5);
		filters.add(diffuseImageOp);*/
		
		/*RippleImageOp doubleRippleImageOp=new RippleImageOp();
		doubleRippleImageOp.setEdgeMode(AbstractImageOp.EDGE_ZERO);
		doubleRippleImageOp.setxAmplitude(1.5);
		doubleRippleImageOp.setxWavelength(8.0);
		doubleRippleImageOp.setyAmplitude(1.5);
		doubleRippleImageOp.setyWavelength(8.0);
		filters.add(doubleRippleImageOp);*/
		
		/*MarbleImageOp marbleImageOp=new MarbleImageOp();
		marbleImageOp.setEdgeMode(AbstractImageOp.EDGE_ZERO);
		marbleImageOp.setAmount(0.5);
		marbleImageOp.setScale(0.5);
		marbleImageOp.setTurbulence(0.5);
		filters.add(marbleImageOp);*/
		/*
		SoftenImageOp softenImageOp=new SoftenImageOp();
		softenImageOp.setEdgeMode(AbstractImageOp.EDGE_ZERO);
		filters.add(softenImageOp);*/
	 ...
	 * @throws IOException
	 */
	public static String outputImage0(OutputStream out) throws IOException {
		ConfigurableCaptchaService cs = new ConfigurableCaptchaService();
		//验证码宽高
		cs.setWidth(85);
		cs.setHeight(35);
